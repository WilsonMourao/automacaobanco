...
at_exit do
  ...
  ReportBuilder.configure do |config|
    ...
    config.report_title = "Relatório de Resultados dos Testes Automatizados Web"
    config.compress_images = false
    config.additional_info = { "Nome do Projeto" => "Banco XYZ", "Plataforma" => "Integração", "Relatório gerado em" => time }
  end
